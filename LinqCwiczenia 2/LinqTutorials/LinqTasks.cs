...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.GetEmpsWithSubordinates(Emps).ToList();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                .Where(dep =>
                    Emps.Count(emp => emp.Deptno == dep.Deptno) == 5 || Emps.All(emp => emp.Deptno != dep.Deptno))
                .ToList();
            //result =
            return result;
        }
        ...
        ///
        /*
         * I MADE CHANGE ON RETURN TYPE BECAUSE HOW THE SELECT STATEMENT WILL BE ABLE TO RETURN IEnumerable<Dept>?
         */
